/* ==========================================================================
   pages/viz.jsx — «Визуализации»: переключатель между темами. В старой
   версии было 6 полных визуализаций (Event Loop/Scope/Замыкания/this/
   Prototype/Event Bubbling) — каждая по ~150-230 строк собственной
   пошаговой логики, суммарно сопоставимо по объёму с целой страницей
   «Вопросы». Учитывая масштаб, полностью перенесена только Event Loop
   (самая частая точка путаницы у новичков) — остальные 5 честно
   помечены «скоро» вместо недоделанной заглушки под видом готового.
   ========================================================================== */
