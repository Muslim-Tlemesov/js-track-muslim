/* ==========================================================================
   pages/shared/code-runner.js — выполнение пользовательского кода — защита от бесконечных циклов, отслеживаемые таймеры, синхронный путь.

   Файл 7 из 18, на которые разбит движок (реорганизовано из 6
